//
//  GenericInstance_MAP_P_Abort_Ind_Task.h
//
...
@interface SS7GenericInstance_MAP_P_Abort_Ind_Task : UMLayerTask
{
...
- (SS7GenericInstance_MAP_P_Abort_Ind_Task *)initWithInstance:(SS7GenericInstance *)inst
