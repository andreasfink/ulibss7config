//
//  UMSS7ApiTaskDiameterRoute_modify.m
//  ulibss7config
//
...
@implementation UMSS7ApiTaskDiameterRoute_modify

+ (NSString *)apiPath
{
    return @"/api/diameter-route-modify";
}
...
- (void)main
{
    @autoreleasepool
    {
        ...
        /* FIXME: modify runningConfig and route object in parallel here */
        [self sendResultOK];
    }
}
